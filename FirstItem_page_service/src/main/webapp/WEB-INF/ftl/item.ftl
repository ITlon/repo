...
<body ng-app="firstItem" ng-controller="itemController" ng-init="num=1;loadDefaultSku()">
							...
							<#list specificationItemsList as spec>
							 <dl>
								<dt>
								 ...
								 <#list spec.attributeValue as sp>
							 	<dd ><a href="javascript:;"
                                  class="{{isSelected('${spec.attributeName}','${sp}')?'selected':''}}"
								  ng-click="selectSpecification('${spec.attributeName}','${sp}')">${sp}
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
                                        <a  class="sui-btn  btn-danger addshopcar" ng-click="addGoodsToCart()">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
